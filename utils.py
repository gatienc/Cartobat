...
end=pd.to_datetime("2023-06-01 23:00:00.000000")-pd.Timedelta(hour_correction, unit="h")
Gatien_API.getRawDataForCartoWear(MAC_WEAR,start,end,"data/manipstatic.csv")
